...
export class PhotoTiltComponent {
  ...
  renderTilt(){
    ...
    this.resizeImageWidth = this.aspectRatio * this.image.nativeElement.height;
    this.renderer.setElementStyle(this.image.nativeElement, 'width', this.resizeImageWidth+'px');
    
    this.delta = this.resizeImageWidth - this.width;
